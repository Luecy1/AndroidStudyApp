...
public class DbDaoTest extends DbTest {
    ...
    @Test
    public void insertContributorsWithoutrepo() throws Exception {
        Repo repo = TestUtil.createRepo("foo", "bar", "desc");
        ...
        try {
            ...
            throw new AssertionError("must fail because repo does not exit");
        } catch (SQLiteException ex) {
        }
    }

    @Test
    public void insertContributors() throws Exception {
        Repo repo = TestUtil.createRepo("foo", "bar", "desc");
